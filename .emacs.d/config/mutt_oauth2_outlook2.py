...
MSAppID = get_secret("outlook2-ms-app-id")
# MSClientSecret = get_secret("outlook2-ms-client-secret") # don't think i need this? 
GPGKey = "jojo_uvamail" # use jojo_uvamail as well (no pwd)

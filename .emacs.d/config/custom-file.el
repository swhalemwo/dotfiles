...
;; counsel fzf helm-rg auto-complete ob-async
...
(custom-set-faces
 ...
 '(diff-refine-added ((t (:inherit diff-refine-changed :background "#92E392"))))
 '(diff-refine-removed ((t (:inherit diff-refine-changed :background "#FF9E9E"))))

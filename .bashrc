...
# xrandr --dpi 276 --fb 3840x4320\
#     --output eDP1 --mode 3840x2160 --pos 0x2160\
#     --output DP3 --scale 2x2 --pos 0x0
...
alias ytd="yt-dlp -i --audio-quality 0 --extract-audio --audio-format mp3 -o '%(title)s.%(ext)s'"
